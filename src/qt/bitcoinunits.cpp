...
QString BitcoinUnits::name(int unit)
{
    switch(unit)
    {
    case BTC: return QString("APCDC");
    case mBTC: return QString("mAPCDC");
    case uBTC: return QString::fromUtf8("μAPCDC");
...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString(QObject::tr("APCDCoins"));
    case mBTC: return QString(QObject::tr("Milli-APCDCoins (1 / 1,000)"));
    case uBTC: return QString(QObject::tr("Micro-APCDCoins (1 / 1,000,000)"));
    default: return QString("???");
    }
}
